                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: Center(child: Text('Add Notification', style: Theme.of(context).textTheme.titleMedium ,)),
                        content: Column(
    ...
    ListTile(
      ...
      onTap: () {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Center(child: Text('Delete Notification', 
